...
public class SpringBatchConfig {
    ...
    public Step step1() {
        return stepBuilderFactory.get("slaveStep").<Customer, Customer>chunk(5)
                ...
                .faultTolerant()
                //.skipLimit(100) //la méthode est appelée avec un argument de 3, cela signifie que la fonction sera exécutée jusqu'à trois fois avant de s'arrêter si elle continue de lever une exception ou une erreur.
                //.skip(NumberFormatException.class) //we tell to the spring if you are finding any number format exception then simply skip that row rather than rollback it and process further
